...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        bing.triggered.connect(self.navigate_to_bing)
        navbar.addAction(bing)

        yahoo = QAction('Yahoo', self)
        yahoo.triggered.connect(self.navigate_to_yahoo)
        navbar.addAction(yahoo)
    ...
    def update_url(self, e):
        self.url_bar.setText(e.toString())
